<template>
    <div class="container mt-5">
      <!-- Buscador -->
      <input type="text" v-model="searchQuery" class="form-control mb-3" placeholder="Buscar asistente..." />
      <h2>Asistentes</h2>
      <button class="btn btn-success mb-3" @click="openModal">Crear Nuevo Asistente</button>
